...
import { ExternalLink, Search, X, Github } from "lucide-react";
    ...
    return (
      <SectionWrapper id="projects">
        ...
        <div className="text-center py-20 text-ink-tertiary dark:text-night-secondary-text">
          <p>
            Could not load GitHub repositories. Please check your username and
            API token.
          </p>
          <a
    ...
    <>
      <SectionWrapper id="featured">
        <SectionHeader
          ...
          title="Key Projects."
          subtitle="Projects I've built that go beyond coursework."
        />
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <a
                  ...
                  className="text-ink-tertiary dark:text-night-secondary-text hover:text-amber transition-colors"
                >
